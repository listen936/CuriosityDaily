...
<style scoped>
	...
	.com-grid-articles-banner {
		position: relative;
		width: 100%;
		height: 100%
	}
	
	.com-grid-articles-banner .swiper-container {
		width: 100%;
		height: 100%
	}
	
	.com-grid-articles-banner .swiper-container .swiper-slide {
		display: block;
		background-size: cover
	}
	
	.com-grid-articles-banner .swiper-container .swiper-slide:after {
		position: absolute;
		top: 0;
		left: 0;
		width: 100%;
	...
	.com-grid-articles-banner .swiper-container .swiper-pagination {
		bottom: 10px;
		left: 0;
		width: 100%;
		line-height: 8px
	...
	.com-grid-articles-banner .swiper-container .swiper-pagination .swiper-pagination-bullet {
		background: hsla(0, 0%, 100%, .9)
	}
	
	.com-grid-articles-banner .swiper-container .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active {
		background: #ffc81f
	}
	
	.com-grid-articles-banner .grid-articles-banner-bd {
		width: 100%;
		height: 100%
	}
	
	.com-grid-articles-banner .grid-articles-banner-bd .swiper-slide .category-title {
		position: absolute;
		bottom: 28px;
		left: 0;
		z-index: 3;
	...
	.com-grid-articles-banner .grid-articles-banner-bd .swiper-slide .category-title .category {
		display: inline-block;
		padding: 0 5px;
		height: 16px;
		background-color: #000;
	...
	.com-grid-articles-banner .grid-articles-banner-bd .swiper-slide .category-title .category img {
		max-height: 100%;
		width: 16px;
		height: 100%
	}
	
	.com-grid-articles-banner .grid-articles-banner-bd .swiper-slide .category-title .category span {
		float: left;
		margin-left: 3px;
		padding: 2px 0;
		color: #ffc81f;
	...
	.com-grid-articles-banner .grid-articles-banner-bd .swiper-slide .category-title .title {
		color: #fff;
		font-weight: 400;
		font-size: 23px;
		line-height: 26px
	...
	.com-grid-article-video {
		display: block;
		width: 100%;
		background: #fff
	}
	
	.com-grid-article-video .grid-article-video-hd {
		position: relative;
		height: 150px;
		height: 7.5rem
	}
	
	.com-grid-article-video .grid-article-video-hd .imgcover img {
		width: 100%
	}
	
	.com-grid-article-video .grid-article-video-hd .play-btn {
		position: absolute;
		top: 45px;
		top: 2.25rem;
		left: 50%;
	...
	.com-grid-article-video .grid-article-video-hd .play-btn:after {
		position: absolute;
		top: 0;
		left: 0;
		width: 100%;
	...
	.com-grid-article-video .grid-article-video-hd .play-btn .iconfont {
		position: absolute;
		z-index: 5;
		width: 100%;
		height: 100%;
	...
	.com-grid-article-video .grid-article-video-hd .play-btn .iconfont:before {
		position: relative;
		left: 2px;
		left: .1rem;
		width: 100%;
	...
	.com-grid-article-video .grid-article-video-hd .play-btn .time {
		position: absolute;
		bottom: -20px;
		bottom: -1rem;
		left: 0;
	...
	.com-grid-article-video .grid-article-video-hd .category {
		position: absolute;
		bottom: 8px;
		left: 15px;
		padding: 0 5px;
	...
	.com-grid-article-video .grid-article-video-hd .category span {
		display: inline-block;
		float: left;
		padding: 2px 0;
		color: #ffc81f;
	...
	.com-grid-article-video .grid-article-video-bd {
		padding: 6px 15px 20px
	}
	
	.com-grid-article-video .grid-article-video-bd .title {
		font-size: 20px;
		line-height: 24px
	}
	
	.com-grid-article-video .grid-article-video-bd .description {
		margin-top: 5px;
		font-size: 14px;
		line-height: 18px;
		opacity: .6;
	...
	.homes.index .page-content {
		width: 100%
	}
	
	.homes.index .page-content .packery-container {
		position: relative
	}
	
	.homes.index .page-content .packery-container .packery-item {
		margin-top: 2px;
		margin-top: .1rem
	}
	
	.homes.index .page-content .packery-container .packery-item.combo .com-grid-article,
	.homes.index .page-content .packery-container .packery-item.combo .com-grid-makemoney {
		width: 159px;
		width: 7.95rem;
		height: 195px;
		height: 9.75rem;
	...
	.homes.index .page-content .packery-container .packery-item.combo .com-grid-article:nth-child(2n),
	.homes.index .page-content .packery-container .packery-item.combo .com-grid-makemoney:nth-child(2n) {
		margin-left: 2px;
		margin-left: .1rem
	}
	
	.homes.index .page-content .packery-container .packery-item.single .com-grid-articles-banner {
		height: 180px;
		height: 9rem;
		background-color: #fff;
		vertical-align: top
	...
	.homes.index .page-content .packery-container .packery-item.single .com-grid-key-article {
		height: 195px;
		height: 9.75rem;
		background-color: #fff;
		vertical-align: top
