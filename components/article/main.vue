         ...
         <div class="com-article-detail short" data-categoryid="4" data-initialized="true" data-guid="3">
            <div class="article-detail-hd">
               <div class="category-tags clearfix">
                  ...
                  <ul class="tags items clearfix" style="display: block;">
                     ...
                     <li class="tag item" data-id="533">
                        <span data-id="533">iOS</span>
                     </li>
                     <li class="tag item" data-id="68">
                        <span data-id="68">苹果</span>
                     </li>
                  </ul>
               </div>
            ...
            <div class="article-detail-ft">
               <ul class="tags items clearfix">
                  ...
                  <li class="tag item" data-id="43951">
                     <span data-id="43951">iPhone X</span>
                  </li>
               </ul>
            ...
            <div class="related-banners-bd">
               ...
               <a href="#" class="com-grid-key-article" data-initialized="true" data-guid="4">
                  ...
                  <div class="grid-key-article-bd">
                     <p class="category">
                        <span class="iconfont icon-zhineng"></span>
                        <span>智能</span>
                     </p>
                     <h1 class="title">iOS 11 小幅更新，多任务手势回来了</h1>
                     <div class="ribbon">
                        <span class="iconfont icon-message">43</span>
                        <span class="iconfont icon-heart">89</span>
                     </div>
                  </div>
               </a>
               <div class="gap"></div>
               <a href="#" class="com-grid-key-article" data-initialized="true" data-guid="5">
                  ...
                  <div class="grid-key-article-bd">
                     ...
                     <div class="ribbon">
                        <span class="iconfont icon-message">97</span>
                        <span class="iconfont icon-heart">611</span>
                     </div>
                  </div>
               </a>
            </div>
