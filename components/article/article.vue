<template>
	<div class="mobile articles show box">
		...
		<div class="com-header-brief clearfix" data-islogined="false" data-id="47038" data-guid="0" data-initialized="true">
			...
			<div class="header-brief-right">
				<a data-ga-event="mobile:click:openApp" data-id="47038" href="#" class="callup-button">打开</a>
			</div>
		</div>
				...
				<div class="related-banners-bd">
					...
					<a href="#" class="com-grid-key-article" data-initialized="true" data-guid="4">
						...
						<div class="grid-key-article-bd">
							...
							<h1 class="title">iOS 11 小幅更新，多任务手势回来了</h1>
							<div class="ribbon"> <span class="iconfont icon-message">43</span> <span class="iconfont icon-heart">89</span> </div>
						</div>
					</a>
					<div class="gap"></div>
					<a href="#" class="com-grid-key-article" data-initialized="true" data-guid="5">
						...
						<div class="grid-key-article-bd">
							<p class="category"> <span class="iconfont icon-zhineng"></span> <span>智能</span> </p>
							<h1 class="title">iOS 11 正式版即将到来，这里有 30 个值得关注的变化</h1>
							<div class="ribbon"> <span class="iconfont icon-message">97</span> <span class="iconfont icon-heart">611</span> </div>
						</div>
					</a>
				</div>
			</div>
		...
		<div class="com-related-comments-brief " data-id="47038" data-initialized="true" data-guid="7">
			<div class="gap"></div>
...
<style scoped>
	...
	.com-header-brief .header-brief-left {
		float: left;
		height: 100%;
		color: #000;
	}
	...
	.com-header-brief .header-brief-left .logo {
		float: left;
		width: 45px;
		height: 45px;
	}
	
	.com-header-brief .header-brief-left .logo img {
		display: block;
		width: 100%;
		height: 100%;
	}
	
	.com-header-brief .header-brief-left .title-slogan {
		padding: 6px 0 4px 58px;
	}
	
	.com-header-brief .header-brief-left .title-slogan h1 {
		font-size: 16px;
		line-height: 16px;
	}
	
	.com-header-brief .header-brief-left .title-slogan p {
		margin-top: 6.5px;
		letter-spacing: 1px;
		font-size: 12px;
		line-height: 12px;
	...
	.com-header-brief .header-brief-right {
		float: right;
		height: 100%;
	}
	
	.com-header-brief .header-brief-right .callup-button {
		display: block;
		margin-top: 4px;
		width: 65px;
		height: 36px;
	...
	.mobile.articles .page-content {
		margin: 0 15px;
		margin: 0 .75rem;
		padding-bottom: 52px;
	}
	
	.mobile.articles .page-content .com-article-detail {
		margin-top: 60px;
	}
	...
	*,
	...
	.com-article-detail .article-detail-hd .category-tags {
		padding: 14px 0;
	}
	...
	.com-article-detail .article-detail-hd .category-tags .category {
		float: left;
		margin-right: 20px;
		font-size: 0;
	}
	...
	.com-article-detail .article-detail-hd .category-tags .category .iconfont {
		font-size: 28px;
	}
	
	.com-article-detail .article-detail-hd .category-tags .category span {
	...
	.com-article-detail .article-detail-hd .category-tags .tags {
		display: none;
		float: right;
	}
	
	.com-article-detail .tags {
		margin: 0;
		padding: 0;
		list-style: none;
		font-size: 12px;
	...
	.com-article-detail .article-detail-hd .category-tags .tags .tag {
		padding-top: 2px;
		padding-bottom: 3px;
	}
	
	.com-article-detail .tags .tag {
		float: left;
	...
	.com-article-detail .tags .tag span {
		padding: 2px 4px;
	...
	.com-article-detail .tags .tag:last-child {
		padding-right: 0;
	}
	...
	.com-article-detail .article-detail-hd .title {
		position: relative;
		padding: 14px 0 12px;
		color: #000;
		font-size: 24px;
	...
	.com-article-detail.short .title:before {
		position: absolute;
		top: 0;
		left: 0;
		width: 100%;
	...
	.com-article-detail .article-detail-hd .author-date {
		height: 25px;
		font-size: 12px;
		line-height: 25px;
	}
	...
	.com-article-detail .article-detail-hd .author-date .author {
		float: left;
		max-width: 80%;
		height: 100%;
	}
	...
	.com-article-detail .article-detail-hd .author-date .author .avatar {
		float: left;
	}
	...
	.com-article-detail .article-detail-hd .author-date .author .name {
		float: left;
		overflow: hidden;
		margin-left: 6px;
		max-width: 80%;
	...
	.com-article-detail .article-detail-hd .author-date .date {
		float: right;
		color: #b2b2b2;
		line-height: 25px;
	}
	...
	.com-article-detail .article-detail-hd .banner img {
		max-width: 100%;
		width: 100%;
		height: 172px;
		height: 8.6rem;
	...
	.com-article-detail .article-detail-hd .com-share {
		margin-top: 15px;
		text-align: right;
	}
	...
	.com-article-detail .article-detail-hd .com-share .share-bd {
		display: inline-block;
	}
	...
	.com-share .share-bd .share.icon-weibo {
		border-color: #ff763b;
		color: #ff763b;
	}
	
	.com-share .share-bd .share {
		float: left;
		margin-right: 9px;
		margin-right: .45rem;
		width: 27px;
	...
	.com-share .share-bd .share.icon-tengxunweibo {
		border-color: #56b6e7;
		color: #56b6e7;
		font-size: 17px;
		font-size: .85rem;
	...
	.com-share .share-bd .share.icon-douban {
		border-color: #33b045;
		color: #33b045;
		font-size: 15px;
		font-size: .75rem;
	...
	.com-share .share-bd .share:last-child {
		margin-right: 0;
	}
	
	.com-share .share-bd .share.icon-linkedin {
		border-color: #39b4f3;
		color: #39b4f3;
		font-size: 16px;
		font-size: .8rem;
	...
	.com-share .share-bd .share.icon-linkedin:before {
		position: relative;
		top: -1px;
		top: -.05rem;
	}
	...
	.com-share .share-bd .share.icon-kongjian {
		border-color: #ffe21f;
		color: #ffe21f;
	}
	...
	.com-article-detail .article-detail-bd .detail .com-insert-images {
		margin-right: -15px;
		margin-right: -.75rem;
		margin-left: -15px;
		margin-left: -.75rem;
	...
	.com-article-detail .article-detail-bd .detail .com-insert-images figure {
		margin: 0;
	}
	...
	.com-article-detail .article-detail-bd .detail .com-insert-images figure img {
		width: 100%;
	}
	...
	.com-article-detail .article-detail-bd .lazyload {
		opacity: 0;
		-ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=0)";
	}
	...
	.com-article-detail .article-detail-ft .share-wrapper .com-share,
	...
	.com-related-banners .related-banners-bd .com-grid-key-article,
...
.com-related-comments-brief .gap {
    position: absolute;
    top: -10px;
    left: 0;
    width: 100%;
...
.com-related-comments-brief .related-comments-brief-bd {
    position: relative;
}
.com-related-comments-brief .related-comments-brief-bd .count {
    padding-top: 15px;
    font-weight: 700;
    font-size: 20px;
    line-height: 20px;
...
.com-comment .comment-right .ribbon .iconfont.icon-message:before {
    top: 0;
}
...
.com-related-comments-brief .related-comments-brief-bd .callup-button {
    padding: 35px 0;
    text-align: center;
}
.com-related-comments-brief .related-comments-brief-bd .callup-button .btn {
    padding: 0;
    width: 202px;
    height: 40px;
    background-color: #000;
